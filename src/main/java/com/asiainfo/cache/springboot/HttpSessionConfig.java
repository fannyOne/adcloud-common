...
@Profile({"qa", "prod", "cloudqa", "pubnet"})
public class HttpSessionConfig {
    ...
    public JedisConnectionFactory redisConnectionFactory() {
        ...
        if (this.isCluster()) {
            ...
            String ipPort = this.getHosts();
            String[] ipPortPair = ipPort.split(":");
            connectionFactory.setHostName(ipPortPair[0].trim());
            connectionFactory.setPort(Integer.valueOf(ipPortPair[1].trim()));
    ...
    private RedisClusterConfiguration redisClusterConfiguration() {
        ...
        redisClusterConfiguration.setClusterNodes(this.getClusterNodes());
