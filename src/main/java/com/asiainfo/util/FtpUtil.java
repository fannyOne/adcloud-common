...
public class FtpUtil {
    ...
    public UploadStatus upload(String local, String remote) throws IOException {
        ...
        //检查远程是否存在文件
        FTPFile[] files = ftpClient.listFiles(new String(remoteFileName.getBytes(encode), "iso-8859-1"));
        if (files.length == 1) {
    ...
    public UploadStatus uploadFile(String remoteFile, File localFile, FTPClient ftpClient, long remoteSize) throws IOException {
        ...
        OutputStream out = ftpClient.appendFileStream(new String(remoteFile.getBytes(encode), "iso-8859-1"));
        //断点续传
        if (remoteSize > 0) {
